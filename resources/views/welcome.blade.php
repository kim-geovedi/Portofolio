...
<body class="bg-dark">
                ...
                <div class="flex items-center px-4 ">
                    ...
                    <nav id="nav-menu" class="hidden absolute py-5 bg-nav shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <a href="#blog" class="text-base text-tulisan py-2 mx-8 flex group-hover:text-primary">Blog</a>
                            </li>
                            <li class="group">
    ...
    <section id="home" class="pt-36">
        <div class="container">
            <div class="flex flex-wrap">
                ...
                <h1 class="text-base font-semibold text-tulisan md:text-xl">Hai, saya <span class="block font-bold text-primary text-4xl my-1 lg:text-5xl">Kim Geovedi</span></h1>
                <h2 class=" font-medium text-lg mb-5 text-tulisan lg:text-2xl">Web Developer | <span class="text-primary">Data Analyst</span></h2>
                <p class="font-medium mb-10 text-paragraf leading-relaxed">Belajar Web Programming Mudah dan menyenangkan <span class="text-primary">bukan!</span></p>
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full mb-10 px-4 lg:w-1/2">
                    ...
                    <h2 class="font-bold text-tulisan text-3xl mb-5 max-w-md lg:text-4xl">Mari Belajar Web Programming Bersama saya</h2>
                    <p class="font-medium text-base text-paragraf max-w-xl lg:text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus culpa eaque in repellendus provident adipisci! Reiciendis.</p>
                </div>
                <div class="w-full px-4 lg:w-1/2">
                    <h3 class="font-semi-bold text-tulisan text-base mb-6 lg:text-3xl lg:pt-10">Mari Berteman</h3>
                    <p class="font-medium text-base text-paragraf max-w-xl mb-10 lg:text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium nobis quam commodi dicta molestiae quidem optio illum eligendi!</p>
    ...
    {{-- Portofolio End--}}
    {{-- Client Start --}}
    <section id="clients" class="pt-36 pb-32 bg-slate-950">
        <div class="container">
            <div class="w-full px-4">
                <div class=" mx-auto text-center mb-16">
                    <h4 class="font-semibold text-lg text-primary">Clients</h4>
                    <h2 class="font-bold text-tulisan text-3xl mb-4 sm:text-4xl lg:text-5xl">Yang Pernah Bekerja Sama</h2>
                    <p class="font-medium text-md text-paragraf md:text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo quos nemo excepturi corrupti! Asperiores et eveniet quis. Provident, quaerat nihil.</p>
                </div>
            </div>
            <div class="w-full px-4">
                <div class="flex flex-wrap items-center justify-center">
                    <a href="#" class="max-[120px] mx-4 py-4 greyscale opacity-60 transition hover:grayscale-0 hover:opacity-100 duration-500 lg:mx-6 xl:mx-8">
                        <img src="img/clients/google2.svg" alt="">
                    </a>
                    <a href="#" class="max-[120px] mx-4 py-4 greyscale opacity-60 transition hover:greyscale-0 hover:opacity-100 duration-500 lg:mx-6 xl:mx-8">
                        <img src="img/clients/gojek.svg" alt="">
                    </a>
                    <a href="#" class="max-[120px] mx-4 py-4 greyscale opacity-60 transition hover:grayscale-0 hover:opacity-100 duration-500 lg:mx-6 xl:mx-8">
                        <img src="img/clients/Tokopedia.svg" alt="">
                    </a>
                    <a href="#" class="max-[120px] mx-4 py-4 greyscale opacity-60 transition hover:grayscale-0 hover:opacity-100 duration-500 lg:mx-6 xl:mx-8">
                        <img src="img/clients/holding1.png" alt="">
                    </a>
                    <a href="#" class="max-[120px] mx-4 py-4 greyscale opacity-60 transition hover:grayscale-0 hover:opacity-100 duration-500 lg:mx-6 xl:mx-8">
                        <img src="img/clients/fb.svg" alt="">
                    </a>
                </div>
            </div>
        </div>
    ...
    {{-- Client End --}}
    {{-- blog Start --}}
    <section id="blog" class="pt-36 pb-16 bg-transaparent">
        <div class="container">
            <div class="w-full px-4">
                <div class="max-w-xl mx-auto text-center mb-16">
                    <h4 class="font-semibold text-lg text-primary">Blog</h4>
                    <h2 class="font-bold text-tulisan text-3xl mb-4 sm:text-4xl lg:text-5xl">Tulisan Terkini</h2>
                    <p class="font-medium text-md text-paragraf lg:text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo quos nemo excepturi corrupti! Asperiores et eveniet quis. Provident, quaerat nihil.</p>
                </div>
            </div>
            <div class="flex flex-wrap">
    ...
    <footer class="bg-dark">
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full px-4 mb-12 text-paragraf font-medium md:w-1/3">
                    <h2 class="font-bold text-4xl text-tulisan mb-5">KIM GEOVEDI</h2>
                    <h3 class="font-bold text-2xl text-tulisan mb-2">Hubungi Kami</h3>
                    <p>mohamadmustofahakim@gmail.com</p>
                    <p>Gg Jragem IV No 13C</p>
                    <p>Sleman, Yogyakarta</p>
                </div>
            <div class="w-full px-4 mb-12 md:w-1/3">
                <h3 class="font-semibold text-xl text-tulisan mb-5">Kategori Tulisan</h3>
                <ul>
                    <li>
                        <a href="#" class="inline-block text-base text-paragraf hover:text-primary mb-2">Programming</a>
                    </li>
                    <li>
                        <a href="#" class="inline-block text-base text-paragraf hover:text-primary mb-2">Otomotif</a>
                    </li>
                    <li>
                        <a href="#" class="inline-block text-base text-paragraf hover:text-primary mb-2">Machine Learning</a>
                    </li>
                </ul>
                </div>
            <div class="w-full px-4 mb-12 md:w-1/3">
                <h3 class="font-semibold text-xl text-tulisan mb-5">Tautan</h3>
                <ul>
                    <li>
                        <a href="#home" class="inline-block text-base text-paragraf hover:text-primary mb-2">Home</a>
                    </li>
                    <li>
                        <a href="#portofolio" class="inline-block text-base text-paragraf hover:text-primary mb-2">Portofolio</a>
                    </li>
                    <li>
                        <a href="#blog" class="inline-block text-base text-paragraf hover:text-primary mb-2">Blog</a>
                    </li>
                    <li>
                        <a href="#contact" class="inline-block text-base text-paragraf hover:text-primary mb-2">Contact</a>
                    </li>
                </ul>
                </div>
            </div>
